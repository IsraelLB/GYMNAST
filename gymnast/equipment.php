...
<body class="bg-white">
        ...
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto p-4 bg-secondary">
                    ...
                    <?php
                    if($id !=null){
                        echo '<a href="equipment.php" class="nav-item nav-link active">Our equipment</a>';
                    }
                    if($tipo == 'cliente'){
                        echo '<a href="team.php" class="nav-item nav-link">Our trainers</a>';
                    }
                    else if($tipo == 'entrenador'){
                        echo '<a href="clientes.php" class="nav-item nav-link">Your Clients</a>';
                    }
                    ?>
    ...
    <div class="container-fluid page-header mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 400px">
            <h4 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase font-weight-bold">Our equipment</h4>
            <div class="d-inline-flex">
                <p class="m-0 text-white"><a class="text-white" href="">Home</a></p>
                <p class="m-0 text-white px-2">/</p>
                <p class="m-0 text-white">Our equipment</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <div class="container pt-5 team">
        <div class="d-flex flex-column text-center mb-5">
            <h4 class="text-primary font-weight-bold">Our equipment</h4>
            <h4 class="display-4 font-weight-bold">Meet Our equipment</h4>
        </div>
        <div class="row">
            <?php
            $query = "SELECT tm.nombre_maquina, tm.descripcion_maquina, tm.imagen
            FROM MaquinasTabla tm
            JOIN Gimnasio g ON tm.estaen = REF(g)
            ...
            while (($row = oci_fetch_array($stid, OCI_ASSOC+OCI_RETURN_NULLS)) != false) {
                ...
                echo "<h4 class='card-title text-primary'>" . $row['NOMBRE_MAQUINA'] . "</h4>\n";
                echo "<p class='card-text'>". $row['DESCRIPCION_MAQUINA'] ."</p>\n";
                echo "</div>\n";
                echo "</div>\n";
                echo "</div>\n";
                $count++;
